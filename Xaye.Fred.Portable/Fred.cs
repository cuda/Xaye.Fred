...
namespace Xaye.Fred
{
    ...
    public partial class Fred
    {
        ...
        {
            var now = CstTime();
            return GetSeriesObservationsAsync(seriesId, observationStart, observationEnd, now, now, Enumerable.Empty<DateTime>(), limit, offset, order, transformation, frequency, method, outputType).Result;
        }
        ...
        {
            var now = CstTime();
            return GetSeriesObservationsAsync(seriesId, new DateTime(1776, 07, 04), new DateTime(9999, 12, 31), now, now, Enumerable.Empty<DateTime>(), limit, offset, order, transformation, frequency, method, outputType).Result;
        }
